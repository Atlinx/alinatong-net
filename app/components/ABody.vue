...
<template>
  <div id="top" class="p-8 sm:py-16 md:px-16 flex justify-center scroll-mt-24">
    <div class="max-w-4xl flex flex-col gap-16">
      ...
      <div class="mt-8 inline-flex flex-wrap text-fg-muted">
